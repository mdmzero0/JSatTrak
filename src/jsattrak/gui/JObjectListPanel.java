...
public class JObjectListPanel extends javax.swing.JPanel
{
    ...
    {//GEN-HEADEREND:event_addCustomSatButtonActionPerformed
        ...
        parentApp.startStatusAnimation();
        
        // get a name from the user:
        String name = JOptionPane.showInputDialog(parentApp,"Custom Satellite Name");
        
         parentApp.stopStatusAnimation();
        
        // if nothing given:
        if(name == null || name.equalsIgnoreCase(""))
        {
            //System.out.println("returned");
            parentApp.setStatusMessage("Custom Satellite Canceled: Either by user or not supplying a name.");
            return;
        }
        
        CustomSatellite prop = new CustomSatellite(name,parentApp.getScenarioEpochDate());
        ...
        parentApp.setStatusMessage("Custom Satellite Added: " + name );
