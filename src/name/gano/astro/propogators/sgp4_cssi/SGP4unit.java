...
*                           original baseline
*       ----------------------------------------------------------------      */
// Converted to Java from C++ by: Shawn E. Gano, 17 June 2009
     ...
     )
{
    ...
    sz1=0; sz2=0; sz3=0; sz11=0; sz12=0; sz13=0; sz21=0; sz22=0; sz23=0; sz31=0; sz32=0; sz33=0;
    z1=0; z2=0; z3=0; z11=0; z12=0; z13=0; z21=0; z22=0; z23=0; z31=0; z32=0; z33=0;
     ...
     return new double[] {snodm, cnodm, sinim, cosim, sinomm, cosomm, day, em, emsq, gam, rtemsq, s1, s2, s3,
                            s4, s5, s6, s7, ss1, ss2, ss3, ss4, ss5, ss6, ss7, sz1, sz2, sz3, sz11, sz12, sz13,
                            sz21, sz22, sz23, sz31, sz32, sz33, nm, z1, z2, z3, z11, z12, z13, z21, z22, z23, z31, z32, z33};
     ...
     )
{
    ...
    // Return variables ------------------------
    double dndt;//, nm; -- nm is also input
     ...
     )
{
    ...
    double ainv, ao, con42, cosio, cosio2, eccsq, omeosq, posq, rp, rteosq, sinio;
     ...
     return new double[] {ainv, ao, con42, cosio, cosio2, eccsq, omeosq, posq, rp, rteosq, sinio};
         ...
         if ((2*pi / satrec.no) >= 225.0)
           {
            ...
            // save ouput vars
             snodm=ttemp2[0]; cnodm=ttemp2[1]; sinim=ttemp2[2]; cosim=ttemp2[3]; sinomm=ttemp2[4]; cosomm=ttemp2[5]; day=ttemp2[6]; em=ttemp2[7]; emsq=ttemp2[8]; gam=ttemp2[9]; rtemsq=ttemp2[10];
             s1=ttemp2[11]; s2=ttemp2[12]; s3=ttemp2[13]; s4=ttemp2[14]; s5=ttemp2[15]; s6=ttemp2[16]; s7=ttemp2[17];
             ss1=ttemp2[18]; ss2=ttemp2[19]; ss3=ttemp2[20]; ss4=ttemp2[21]; ss5=ttemp2[22]; ss6=ttemp2[23]; ss7=ttemp2[24];
             sz1=ttemp2[25]; sz2=ttemp2[26]; sz3=ttemp2[27]; sz11=ttemp2[28]; sz12=ttemp2[29]; sz13=ttemp2[30]; sz21=ttemp2[31]; sz22=ttemp2[32]; sz23=ttemp2[33]; sz31=ttemp2[34]; sz32=ttemp2[35]; sz33=ttemp2[36];
             nm=ttemp2[37];
             ...
             em=ttemp3[0]; argpm=ttemp3[1]; inclm=ttemp3[2];
             mm=ttemp3[3]; nm=ttemp3[4]; nodem=ttemp3[5]; dndt=ttemp3[6];
           }
     ...
     if (satrec.method == 'd')
       {
         ...
         // copy variables back
         em=ttemp[0]; argpm=ttemp[1]; inclm=ttemp[2];
         mm=ttemp[3];nodem=ttemp[4]; dndt=ttemp[5]; nm=ttemp[6];
