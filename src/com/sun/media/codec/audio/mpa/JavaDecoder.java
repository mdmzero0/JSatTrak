...
public class JavaDecoder extends AudioCodec
{
    ...
    public JavaDecoder()
    {
        ...
        super.inputFormats = (new Format[] {
            new AudioFormat("mpegaudio", 16000D, -1, -1, -1, 1), new AudioFormat("mpegaudio", 22050D, -1, -1, -1, 1), new AudioFormat("mpegaudio", 24000D, -1, -1, -1, 1), new AudioFormat("mpegaudio", 32000D, -1, -1, -1, 1), new AudioFormat("mpegaudio", 44100D, -1, -1, -1, 1), new AudioFormat("mpegaudio", 48000D, -1, -1, -1, 1)
        });
    }
        ...
        throws ResourceUnavailableException
    {
        ...
        try
        {
            ...
            expectingSameInputBuffer = false;
            accumTS = 0L;
            aFormat = (AudioFormat)super.outputFormat;
            return;
        }
        catch(Throwable e)
        {
