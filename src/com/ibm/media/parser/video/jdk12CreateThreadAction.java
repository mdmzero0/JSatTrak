    ...
    implements PrivilegedAction
{
    ...
    static 
    {
        try
        {
            cons = (com.ibm.media.parser.video.jdk12CreateThreadAction.class).getConstructor(new Class[] {
                java.lang.Class.class
            });
            conswithname = (com.ibm.media.parser.video.jdk12CreateThreadAction.class).getConstructor(new Class[] {
