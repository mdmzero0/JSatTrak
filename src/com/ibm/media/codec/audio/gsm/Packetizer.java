...
public class Packetizer extends AudioPacketizer
{
    ...
    public Packetizer()
    {
        ...
        super.supportedInputFormats = (new AudioFormat[] {
            new AudioFormat("gsm", 8000D, -1, 1, -1, -1, 264, -1D, Format.byteArray)
        });
        super.defaultOutputFormats = (new AudioFormat[] {
            new AudioFormat("gsm/rtp", 8000D, -1, 1, -1, -1, 264, -1D, Format.byteArray)
        });
        super.PLUGIN_NAME = "GSM Packetizer";
    }
    ...
    public synchronized void setPacketSize(int newPacketSize)
    {
        ...
        super.sample_count = (super.packetSize / 33) * 160;
