...
//            System.out.println("Segment type=" + segment.segmentType + ", id=" + segId);
    ...
    public static NITFSMessage load(java.io.File file) throws java.io.IOException
    {
        ...
        {
            roBuffer = null;
            String message = Logging.getMessage("NITFSReader.UnknownOrUnsupportedNITFSFormat", file.getCanonicalPath());
            Logging.logger().severe(message);
            throw new NITFSRuntimeException(message);
        }
    ...
    private static void validateImageFile(java.io.File file)
        ...
        {
            String message = Logging.getMessage("NITFSReader.NoFileOrNoPermission", file.getCanonicalPath());
            Logging.logger().severe(message);
            throw new NITFSRuntimeException(message);
        }
    }
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            NITFSMessage img = load(new File(testImageFilename));
