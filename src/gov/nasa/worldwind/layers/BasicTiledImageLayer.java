...
/**
 * @author tag
 * @version $Id: BasicTiledImageLayer.java 3558 2007-11-17 08:36:45Z tgaskins $
 */
public class BasicTiledImageLayer extends TiledImageLayer
{
    ...
    protected void downloadTexture(final TextureTile tile)
    {
        ...
        Integer cto = AVListImpl.getIntegerValue(this, AVKey.URL_CONNECT_TIMEOUT, 8000);
        if (cto != null && cto > 0)
            retriever.setConnectTimeout(cto);
        Integer cro = AVListImpl.getIntegerValue(this, AVKey.URL_READ_TIMEOUT, 5000);
        if (cro != null && cro > 0)
            retriever.setReadTimeout(cro);
        Integer srl = AVListImpl.getIntegerValue(this, AVKey.RETRIEVAL_QUEUE_STALE_REQUEST_LIMIT, 9000);
        if (srl != null && srl > 0)
